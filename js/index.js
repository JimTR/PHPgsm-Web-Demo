			...
			for (var j in data1[i]) {
				...
				if (server.running == 1 ) {
					...
					if (server.Players ==0 ) {
						...
						for (p in players) {
							newRowContent='<tr style="font-size:14px;"><td style="width:50% !important;"><i class="p_name">'+players[p].Name+'</i></td><td style="text-align:right;width:15%; color:#ccc;" >'+players[p].Frags+'</td><td style=text-align:right;padding-right:3%;width:20%" class="p_time">'+players[p].TimeF+'</td></tr>'; 
